//$('body').append('<script src="https://cdn.jsdelivr.net/gh/irmaindahmanis/kinerjajft@main/kinerjav2hack.js"></script>')
...
fetch(`${proto}//kinerjajft2023.pareparekota.go.id/c_aktifitas/tambah_skp_30`)
  .then(res => {
    return res.text()
  })
  .then(resp => {
...
function kirim(parmTgl, parmAktifitas, parmKuantitas, parmDd, parmJamMulai, parmJamSelesai, parmKinerja, parmIdKegiatan, parmThnAktif, parmBlnAktif, parmBanyakRow, parmResetRow, parmNip) {
  ...
  let urlTambah = `${proto}//kinerjajft2023.pareparekota.go.id/c_aktifitas/aksi_tambah_skp_30`
